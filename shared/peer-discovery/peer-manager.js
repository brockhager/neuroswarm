...
import { PeerCertificateValidator } from './peer-certificate-validator.js';
...
export class PeerManager {
    ...
    getNodeInfo() {
        ...
        // Certificate info (Phase 4C)
        let certInfo = null;
        if (this.certValidator) {
            certInfo = this.certValidator.getNodeIdentity(this.nodeId, this.nodeType);
        }
        ...
        return {
            ...
            certificateFingerprint: certInfo?.certificateFingerprint
        };
    }
}
