...
class MockGovernanceService {
    ...
    castVote(proposalId, voterId, choice, votingPower, badgeTier = 'Bronze') {
    ...
    calculateIncentives(voterId, proposal, choice, votingPower, badgeTier) {
        const baseRewards = { Bronze: 5, Silver: 7.5, Gold: 10, Diamond: 15 };
...
//# sourceMappingURL=test-quorum-validation.js.map