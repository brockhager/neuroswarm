...
This wiki page provides a full end-to-end reference for NeuroSwarm's data flows: ingress, internal processing, egress, and network propagation. It mirrors the canonical source in `docs/data-flow-architecture.md`, but this file can be edited in PRs targeted at the wiki if needed for faster updates and community review.
